        ...
        <div className={styles.cont}>
          <div className={styles.head}>
            <SectionHeading
              ...
              subHead="ARCZENRICK"
              smallHead="CAREERS"
              caption="Join Azenrick, where talent meets opportunity, and together, we create impactful solutions in a dynamic and rewarding workplace."
            />
          </div>
          <br />
          <br />
          ...
          <SectionHeading
            ...
            caption="At Azenrick, we believe that innovation thrives in an environment where creativity meets collaboration. Our workspace is designed to inspire, motivate, and empower our team to reach their full potential."
          />
          <br />
            ...
            <ol>
              <li>
                <p>
                  ...
                  member is encouraged to think outside the box. At Azenrick,
              ...
              <li>
                <p>
                  ...
                  certifications and mentorship, Azenrick ensures you’re always
              ...
              <li>
                <p>
                  ...
                  <br />
                  At Azenrick, you’ll work with state-of-the-art tools and
              ...
              <li>
                <p>
                  ...
                  where everyone feels valued and respected. At Azenrick,
